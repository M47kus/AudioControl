...
void setup()
{
  ...
  button1.setDebounceTime(20); // set debounce time to 100 milliseconds
  button2.setDebounceTime(20); // set debounce time to 100 milliseconds
  button3.setDebounceTime(20); // set debounce time to 100 milliseconds
  button4.setDebounceTime(20); // set debounce time to 100 milliseconds
  button5.setDebounceTime(20); // set debounce time to 100 milliseconds
  button6.setDebounceTime(20); // set debounce time to 100 milliseconds
}
...
void loop()
{
  ...
  std::string str2 = "A1:" + std::to_string(value_2) + ":" + conv_bool(mute_2);
